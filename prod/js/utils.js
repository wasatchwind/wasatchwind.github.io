...
function marqueeHtmlComponent() {
  ...
  const tickers = [
    ...
    { id: "KSLC-time-12", bottomRow: `<div class="d-flex justify-content-center">KSLC<div id="KSLC-wdir-12"></div><div class="ms-3" id="KSLC-wspd-12"></div><div class="gust-color fs-1 ms-3" id="KSLC-gust-12"></div></div>` },
