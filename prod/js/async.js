...
(async () => {
  ...
  // const gcpWindAloftURL = 'https://python-wind-aloft-ftp-483547589035.us-west2.run.app' // GCP Cloud Run Function, does not use CORS
  const gcpWindAloftURL = 'https://2kjkumjjzukwnuiomukqzexcfy0yfynp.lambda-url.us-west-1.on.aws' // AWS Lambda, uses CORS
